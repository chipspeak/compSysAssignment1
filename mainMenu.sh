...
welcome_greeting() {
    ...
    echo "${BOLD}GITHUB:https://github.com/chipspeak${NC}"
    welcome_spacing
    echo ""
...
echo "${BOLD}${CYAN}Loading main menu...${NC}"
sleep 3
clear
##main menu while loop where the use is presented their menu choices. A case is then used to direct to the appropriate subscript as needed based on response.
